...
class TestSelectBestObject(TestCase):
    ...
    def test_select_one_over_one_under_threshold(self):
        df = pd.DataFrame({
    ...
    def test_select_both_under_threshold(self):
        data = {
            'xmin': [247.751923, 417.493927],
            'ymin': [253.096268, 291.238037],
            'xmax': [257.412170, 454.949219],
            'ymax': [262.040070, 427.892731],
            'confidence': [0.830767, 0.872015],
            'class': [14, 27],
            'name': ["25", "38"]
        }
    ...
    def test_select_both_over_threshold(self):
        data = {
            'xmin': [247.751923, 417.493927],
            'ymin': [253.096268, 291.238037],
            'xmax': [257.412170, 454.949219],
            'ymax': [262.040070, 427.892731],
            'confidence': [0.930767, 0.972015],
            'class': [14, 27],
            'name': ["25", "38"]
        }
        df = pd.DataFrame(data)
    ...
    def test_select_only_class_ignore_threshold(self):
        data = {
            'xmin': [417.493927],
            'ymin': [291.238037],
            'xmax': [454.949219],
